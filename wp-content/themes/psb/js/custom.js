...
jQuery('.test_slider_one').slick({
  ...
  fade:true,
  adaptiveHeight: true,
  asNavFor: '.test_slider_two'
});


jQuery('.test_slider_two').slick({
  infinite: true,
  slidesToShow: 1,
  slidesToScroll: 1,
  dots:false,
...
jQuery('.small_single_case_two').mouseenter(function(){
	...
	jQuery('.large_single_case_two').fadeIn(600);

	jQuery('.large_single_case').not('.large_single_case_two').hide();
...
jQuery('.small_single_case_three').mouseenter(function(){
	...
	jQuery('.large_single_case_three').fadeIn(600);

	jQuery('.large_single_case').not('.large_single_case_three').hide();
...
jQuery('.small_single_case_four').mouseenter(function(){
	...
	jQuery('.large_single_case_four').fadeIn(600);

	jQuery('.large_single_case').not('.large_single_case_four').hide();
...
jQuery(window).scroll(function () {
   if (jQuery(this).scrollTop() > 10) {
      ...
      jQuery('header').addClass('show_bg');
      
   } 
   if (jQuery(this).scrollTop() < 10) {
     
      jQuery('header').removeClass('show_bg');
